...
import { type TabView, type TabViewProps } from "react-native-tab-view";
...
export declare function createCollapsibleTabsComponent<T extends Route>(Component: React.PropsWithRef<typeof TabView>): React.ForwardRefExoticComponent<Partial<TabViewProps<T>> & Pick<TabViewProps<T>, "navigationState" | "onIndexChange" | "renderScene"> & CollapsibleHeaderProps<T> & React.RefAttributes<object>>;
